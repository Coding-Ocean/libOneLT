...
float VECTOR::crossXY(const VECTOR& v) const{
    return x * v.y - y * v.x;
}
float VECTOR::crossXZ(const VECTOR& v) const {
    return x * v.z - z * v.x;
}
...
float crossXY(const VECTOR& a, const VECTOR& b) {
    return a.x * b.y - a.y * b.x;
}
float crossXZ(const VECTOR& a, const VECTOR& b) {
